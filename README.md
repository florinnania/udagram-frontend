...
> _tip_: this frontend is designed to work with [The RestAPI Backend](https://github.com/florinnania/udagram-restapi-backend). It is recommended you stand up the backend first, test using Postman, and then the frontend should integrate.
